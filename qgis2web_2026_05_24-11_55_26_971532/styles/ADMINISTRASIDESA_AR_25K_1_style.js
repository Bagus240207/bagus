...
var style_ADMINISTRASIDESA_AR_25K_1 = function(feature, resolution){
    ...
    if (value >= 0.000085 && value <= 0.000290) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.000290 && value <= 0.000453) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.000453 && value <= 0.000636) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.000636 && value <= 0.000942) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.000942 && value <= 0.009372) {
            style = [ new ol.style.Style({
